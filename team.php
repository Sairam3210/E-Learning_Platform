...
<?php 
        $query = "SELECT * FROM `team` WHERE name = 'Gorle SaiKiran'";
...
?>
							...
							<div class="team team-list clearfix">
								<div class="team-image">
									<img src="gotoep/images/team/ <?php if(isset($ChairmanPic)) echo $ChairmanPic; ?>" alt="Mr.Shaik Annas">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4>Mr.Shaik Annas</h4><span>Chairman</span></div>
...
<?php 
        $query = "SELECT * FROM `team` WHERE name = 'Chinnam Rufas'";
...
?>
						...
						<div class="col-md-6 bottommargin">
							...
							<div class="team team-list clearfix">
								<div class="team-image">
									<img src="gotoep/images/team/<?php if(isset($ceoPic)) echo $ceoPic; ?>" alt="Mr. John Deo">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4>Mr. John Deo</h4><span>CEO</span></div>
...
<?php 
        // $query = "SELECT * FROM team WHERE name != 'Chinnam Rufas' AND name != 'Gorle SaiKiran' ";
