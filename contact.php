...
<?php
	...
	if(isset($_POST['submit'])){        
        ...
        if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
            ...
            $to = "rufaschinnam@gmail.com"; //Programmers email
            ...
            $header  = "saikirangorle909@gmail.com";
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<abbr title="Phone Number"><strong>Phone:</strong></abbr> 7989010109<br>
						<abbr title="Phone Number"><strong>Phone:</strong></abbr> 9093831034<br>
						<abbr title="Email Address"><strong>Email:</strong></abbr> ksr567@gmail.com
						<abbr title="Email Address"><strong>Email:</strong></abbr> gcweabcd@gmail.com

					
						<div class="widget noborder notoppadding">

							<a target="_blank" href="https://www.facebook.com/saikiran.gorle.52" class="social-icon si-small si-dark si-facebook">
								<i class="icon-facebook"></i>
								<i class="icon-facebook"></i>
							</a>

							<a target="_blank" href="https://x.com/chinnam_rufas" class="social-icon si-small si-dark si-twitter">
								<i class="icon-twitter"></i>
								<i class="icon-twitter"></i>
							</a>

							<a target="_blank" href="https://youtu.be/-t_crooCckA?si=4k3VDIeQPjBXY-Mp" class="social-icon si-small si-dark si-youtube">
							...
							<a target="_blank" href="https://github.com/GORLESAIKIRAN/BUDJECT-TRACKER" class="social-icon si-small si-dark si-github">
